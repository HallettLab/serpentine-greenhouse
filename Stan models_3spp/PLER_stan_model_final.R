...
pler_lo_int <- stan(file = "pler_bevertonholt_model.stan", 
                    data = c("N", "Fecundity", "intra", "pler", "brho", "lapl", "P", "Plot","pg","bg","lg"),
                    iter = 15000, chains = 3, thin = 10, control = list(adapt_delta = 0.9999999, max_treedepth = 50),
                    init = initials1)
...
pler_lo_lo <- stan(file = "pler_bevertonholt_model.stan", 
                   data = c("N", "Fecundity", "intra", "pler", "brho", "lapl", "P", "Plot","pg","bg","lg"),
                   iter = 15000, chains = 3, thin = 6, control = list(adapt_delta = 0.999999, max_treedepth = 40),
                   init = initials1)
