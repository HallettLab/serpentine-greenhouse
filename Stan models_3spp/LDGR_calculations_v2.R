...
pop.invade <- function (N0, resident, s, g, a_inter, a_intra, lambda, g_resident, g_intra) {
  # to run for only a single timestep
  N <- s*(1-g)*N0 + N0*(lambda*g)/(1+a_inter*resident*g_resident+a_intra*N0*g)
  return(N)
}
...
for (i in 1:length(posts)){
  ...
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_pler[i],
                                a_intra = alphas_intra[i], resident = N_pler_hi_hi[i], N0 = 1, g_resident=pg ))
...
for (i in 1:length(posts)){
  ...
  ldgr_out[i] <- log(pop.invade(s = ls, g = lg, lambda=lambdas[i], a_inter = alphas_inter_brho[i],
                                a_intra = alphas_intra[i], resident = N_brho_hi_hi[i], N0 = 1, g_resident=bg ))
...
for (i in 1:length(posts)){
  ...
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_lapl[i],
                                a_intra = alphas_intra[i], resident = N_lapl_hi_hi[i], N0 = 1, g_resident=lg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = ps, g = pg, lambda=lambdas[i], a_inter = alphas_inter_brho[i],
                                a_intra = alphas_intra[i], resident = N_brho_hi_int[i], N0 = 1, g_resident=bg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_pler[i],
                                a_intra = alphas_intra[i], resident = N_pler_hi_int[i], N0 = 1, g_resident=pg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_lapl[i],
                                a_intra = alphas_intra[i], resident = N_lapl_hi_int[i], N0 = 1, g_resident=lg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = ps, g = pg, lambda=lambdas[i], a_inter = alphas_inter_brho[i],
                                a_intra = alphas_intra[i], resident = N_brho_hi_lo[i], N0 = 1, g_resident=bg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_pler[i],
                                a_intra = alphas_intra[i], resident = N_pler_hi_lo[i], N0 = 1, g_resident=pg ))
...
for (i in 1:length(posts)){
  ...
  ldgr_out[i] <- log(pop.invade(s = ls, g = lg, lambda=lambdas, a_inter = alphas_inter_brho,
                                a_intra = alphas_intra, resident = N_brho_hi_lo[i], N0 = 1, g_resident=bg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_lapl[i],
                                a_intra = alphas_intra[i], resident = N_lapl_hi_lo, N0 = 1, g_resident=lg ))
...
for (i in 1:length(posts)){
  ...
  ldgr_out[i] <- log(pop.invade(s = ls, g = lg, lambda=lambdas, a_inter = alphas_inter_pler,
                                a_intra = alphas_intra, resident = N_pler_hi_lo[i], N0 = 1, g_resident=pg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = ps, g = pg, lambda=lambdas[i], a_inter = alphas_inter_brho[i],
                                a_intra = alphas_intra[i], resident = N_brho_lo_hi[i], N0 = 1, g_resident=bg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_pler[i],
                                a_intra = alphas_intra[i], resident = N_pler_lo_hi[i], N0 = 1, g_resident=pg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_lapl[i],
                                a_intra = alphas_intra[i], resident = N_lapl_lo_hi[i], N0 = 1, g_resident=lg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = ps, g = pg, lambda=lambdas[i], a_inter = alphas_inter_brho[i],
                                a_intra = alphas_intra[i], resident = N_brho_lo_int[i], N0 = 1, g_resident=bg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_pler[i],
                                a_intra = alphas_intra[i], resident = N_pler_lo_int[i], N0 = 1, g_resident=pg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_lapl[i],
                                a_intra = alphas_intra[i], resident = N_lapl_lo_int[i], N0 = 1, g_resident=lg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = ps, g = pg, lambda=lambdas[i], a_inter = alphas_inter_brho[i],
                                a_intra = alphas_intra[i], resident = N_brho_lo_lo[i], N0 = 1, g_resident=bg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_pler[i],
                                a_intra = alphas_intra[i], resident = N_pler_lo_lo[i], N0 = 1, g_resident=pg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = ls, g = lg, lambda=lambdas, a_inter = alphas_inter_brho,
                                a_intra = alphas_intra, resident = N_brho_lo_lo[i], N0 = 1, g_resident=bg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = bs, g = bg, lambda=lambdas[i], a_inter = alphas_inter_lapl[i],
                                a_intra = alphas_intra[i], resident = N_lapl_lo_lo, N0 = 1, g_resident=lg ))
...
for (i in 1:length(posts)){
  ...
  # of brho's equilibrium abundance.
  ldgr_out[i] <- log(pop.invade(s = ls, g = lg, lambda=lambdas, a_inter = alphas_inter_pler,
                                a_intra = alphas_intra, resident = N_pler_lo_lo[i], N0 = 1, g_resident=pg ))
